        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div className="flex flex-col md:items-end space-y-4">
            ...
            <div className="flex gap-4">
              ...
              {/* Email*/}
              <a href="mailto:hello@bipolarfactory.com" className="bg-black p-3 rounded-full text-white hover:bg-[#f25f2c] transition-colors inline-flex items-center justify-center">
